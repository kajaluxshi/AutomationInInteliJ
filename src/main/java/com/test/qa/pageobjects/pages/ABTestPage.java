...
public class ABTestPage extends PageBase {
    ...
    public static boolean isABTestPageDisplayed() {   return getDriver().findElement(hdrABTest).isDisplayed(); }
    public static void waitTillHeaderLoad() {   waiTillVisible(hdrABTest, 2); }
